...
import llmlib.architectures.models.conv.gpn # needed for AutoConfig
import llmlib.architectures.models.mamba.caduceus as caduceus_module
...
def build_model(cfg: DictConfig):
    if cfg.name == 'hf_bert':
        ...
        model  = mosaic_bert_module.create_mosaic_bert_mlm(
            pretrained_model_name=cfg.pretrained_model_name,
            ...
            gradient_checkpointing=cfg.get('gradient_checkpointing', None))
        return model
    elif cfg.name == 'caduceus':
        model = caduceus_module.create_caduceus_mlm(
            pretrained_model_name=cfg.pretrained_model_name,
            tokenizer_name=cfg.get('tokenizer_name', "songlab/tokenizer-dna-mlm"),
            use_pretrained=cfg.get('use_pretrained', None),
            model_config=cfg.get('model_config', None),
        )
        return model
...
def main(cfg: DictConfig,
    ...
    time.sleep(10) # See if this avoids the race condition
