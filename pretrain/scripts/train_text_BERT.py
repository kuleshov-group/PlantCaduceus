...
#config.alibi_starting_size = LENGTH_SiZE
print(config)
...
model = mosaic_bert_module.create_mosaic_bert_mlm(
            pretrained_model_name="mosaicml/mosaic-bert-base",
            pretrained_checkpoint=None, #cfg.get('pretrained_checkpoint', None),
            model_config=config.to_dict(), #cfg.get('model_config', None),
