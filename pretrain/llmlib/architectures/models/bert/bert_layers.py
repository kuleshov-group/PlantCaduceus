...
class BertUnpadSelfAttention(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, cu_seqlens: torch.Tensor,
                ...
                attn_mask: torch.Tensor, bias: torch.Tensor, slopes: torch.Tensor) -> torch.Tensor:
        ...
        if (not IMPL_USE_FLASH and self.p_dropout) or flash_attn_qkvpacked_func is None:
            ...
            if IMPL_USE_FLASH:
                ...
                if convert_dtype:
                    ...
                    attention = flash_attn_qkvpacked_func(qkv,
...
class BertLayer(nn.Module):
    ...
    def forward(
        ...
        attention_output = self.attention(hidden_states, cu_seqlens, seqlen,
                                          subset_idx, indices, attn_mask, bias, slopes)
